  ...
  const fetchAsset = async () => {
    try {
      ...
      setFormData({
        ...
        originalCost: a.original_cost ? String(a.original_cost) : "",
        depreciationRate: a.depreciation_rate ? String(a.depreciation_rate) : "",
        wdvAsMarch31: a.wdv_as_march_31 ? String(a.wdv_as_march_31) : "",
        transferredDisposalDetails: a.transferred_disposal_details ?? "",
        valuationAtTransferDisposal: a.valuation_at_transfer_disposal
          ? String(a.valuation_at_transfer_disposal)
          : "",
        scrapValueRealised: a.scrap_value_realised
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        assetTagging: formData.assetTagging,
        serialNumber: formData.serialNumber,
        location: formData.location,
        dateOfPurchase: formData.dateOfPurchase,
        taxInvoiceNo: formData.taxInvoiceNo,
        vendorSupplierNameAddress: formData.vendorSupplierNameAddress,
        originalCost: formData.originalCost,
        depreciationRate: formData.depreciationRate,
        wdvAsMarch31: formData.wdvAsMarch31,
        transferredDisposalDetails: formData.transferredDisposalDetails,
        valuationAtTransferDisposal: formData.valuationAtTransferDisposal,
        scrapValueRealised: formData.scrapValueRealised,
        remarksAuthorisedSignatory: formData.remarksAuthorisedSignatory,
      };
